...
opt.shockname = char('Productivity Shock');
% opt.epsshock = char('epsdelta');
% opt.shockname = char('Depreciation Shock');
opt.data_files_desc = {'rbc','gkq','obc'};
opt.num_datasets = 3;
opt.data_files = {...
    ...'rbc_irfs_order3_X3_fast_phi2_shocksPsiA_habitC70_habitH0_sepUtil'...
    ...,'newobc_irfs_order3_X3_fast_phi2_shocksPsiA_habitC70_habitH0_sepUtil'...
    ...'rbc_irfs_order3_X3_fast_phi2_shocksNegPsiA_habitC70_habitH0_sepUtil'...
